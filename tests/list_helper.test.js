...
describe('most blogs', () => {
  ...
  test('when list has only many blogs, returns the author with most likes', () => {
...
describe('most likes', () => {
  ...
  test('when list has only one blog, return author of that blog and its number of likes', () => {
